	...
	<div class="module form-module">
		...
		<div class="form ">
			...
			<form action="" method="post">
				<input style="border-radius: 8px;" type="text" placeholder="Username" name="username" />
				<input style="border-radius: 8px;" type="password" placeholder="Password" name="password" />
