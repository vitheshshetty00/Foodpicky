            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/admin.jpg" alt="user" class="profile-pic" /></a>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$fetch['title'].'</td>
																								...
																								<center><img src="Res_img/dishes/'.$rows['img'].'" class="img-responsive  radius" style="min-width:150px;min-height:100px; max-height:100px;max-width:150px;" /></center>
																								</div></td>
