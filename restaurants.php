                            ...
                            <div class="bg-gray restaurant-entry">
								...
								<?php $ress= mysqli_query($db,"select * from restaurant");
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div style="border: 1px solid #484b4b; border-radius:8px" class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo" style="border-radius: 8px;">
