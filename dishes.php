...
<body style="background:rgb(254 254 254 / 68%);">
                                    ...
                                    <div class="row">
										...
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a style="max-width: 130px;" class="restaurant-logo pull-left" href="#"><?php echo '<img style="border-radius:8px;" src="admin/Res_img/dishes/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
                                            <div class="rest-descr" style="margin-left: 25px;">
